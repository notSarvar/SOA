...
func TestCreatePromo(t *testing.T) {
	...
	t.Run("successful creation by business user", func(t *testing.T) {
		...
		// Выполнение
		result, err := service.CreatePromo(ctx, req, userID, promo.UserRole_BUSINESS)
	...
	t.Run("creation by non-business user should fail", func(t *testing.T) {
		...
		result, err := service.CreatePromo(ctx, req, userID, promo.UserRole_CUSTOMER)
		assert.Error(t, err)
		assert.Nil(t, result)
...
func TestUpdatePromo(t *testing.T) {
	...
	t.Run("successful update by creator", func(t *testing.T) {
		...
		// Выполнение
		result, err := service.UpdatePromo(ctx, req, userID, promo.UserRole_CUSTOMER)
	...
	t.Run("update by non-creator should fail", func(t *testing.T) {
		...
		result, err := service.UpdatePromo(ctx, req, otherUserID, promo.UserRole_CUSTOMER)
		assert.Error(t, err)
		assert.Nil(t, result)
...
func TestDeletePromo(t *testing.T) {
	...
	t.Run("successful deletion by creator", func(t *testing.T) {
		...
		// Выполнение
		err := service.DeletePromo(ctx, promoID, userID, promo.UserRole_CUSTOMER)
	...
	t.Run("deletion by non-creator should fail", func(t *testing.T) {
		...
		err := service.DeletePromo(ctx, promoID, otherUserID, promo.UserRole_CUSTOMER)
		assert.Error(t, err)
